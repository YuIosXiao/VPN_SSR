...
public class AppLoginActivity extends BaseActivity {
    ...
    protected void backUpActivity(){
        ...
        AppManager.getAppManager().AppExit(AppLoginActivity.this);
    }
    ...
    private void dologin() {
        ...
        loadingView = new LoadingDialog.Builder(AppLoginActivity.this)
                .setMessage(getString(R.string.loading_text))
                .setCancelable(false)
                .create();
        loadingView.show();
        String ssr = mSharedPreference.getString("ssr", "");
        String imei = Unique.getid(AppLoginActivity.this);
        String mac = Unique.getMacid(AppLoginActivity.this);
        ...
        loginCall.enqueue(new Callback<UserInfoModel>() {
            ...
            public void onResponse(Call<UserInfoModel> call, Response<UserInfoModel> response) {
                ...
                if (response.body().getStatus() == REQ_SUCCESS) {
                    ...
                    ToastUtils.showShort(AppLoginActivity.this, getString(R.string.loading_success));
                    Intent mainIntent = new Intent(AppLoginActivity.this, AppSplashActivity.class);
                    startActivity(mainIntent);
                    //getUserInfo();
                    AppManager.getAppManager().finishActivity(AppLoginActivity.this);
                    finish();
                } else {
                    int error_code = response.body().getError_code();
                    Log.d("'a1a1a1a1", error_code+"");
                    ToastUtils.showShort(AppLoginActivity.this, map.get(error_code));
                }
            }
            ...
            public void onFailure(Call<UserInfoModel> call, Throwable t) {
                loadingView.dismiss();
                ToastUtils.showShort(AppLoginActivity.this, getString(R.string.loading_failure));
            }
        });
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_register:
                Intent intent = new Intent(AppLoginActivity.this, RegisterAppActivity.class);
                startActivity(intent);
                break;
            case R.id.tv_forget:
                Intent forgetIntent = new Intent(AppLoginActivity.this, ForgetPWDActivity.class);
