...
public class WeekView extends View {
    ...
    private String[] mWeeks = {getContext().getString(R.string.Sun), getContext().getString(R.string.Mon), getContext().getString(R.string.Tue), getContext().getString(R.string.Wed), getContext().getString(R.string.Thu), getContext().getString(R.string.Fri), getContext().getString(R.string.Sat)};
